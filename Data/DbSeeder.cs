        ...
        public static async Task SeedAsync(ApplicationDbContext context)
        {
            ...
            if (!context.Vehicles.Any())
            {
                context.Vehicles.AddRange(
                    new Vehicle { Brand = "Toyota", Model = "Camry", Type = VehicleType.Sedan, PricePerDay = 12000.00m, Year = 2023, LicensePlate = "ABC-1234", IsAvailable = true, Description = "Comfortable mid-size sedan with excellent fuel economy. Features include adaptive cruise control, lane departure warning, and a spacious interior.", ImageUrl = "/images/vehicles/toyota-camry.jpg" },
                    new Vehicle { Brand = "Honda", Model = "CR-V", Type = VehicleType.SUV, PricePerDay = 18000.00m, Year = 2024, LicensePlate = "DEF-5678", IsAvailable = true, Description = "Spacious SUV perfect for family trips. Equipped with Honda Sensing suite, panoramic sunroof, and ample cargo space.", ImageUrl = "/images/vehicles/honda-crv.jpg" },
                    new Vehicle { Brand = "Ford", Model = "F-150", Type = VehicleType.Truck, PricePerDay = 20000.00m, Year = 2023, LicensePlate = "GHI-9012", IsAvailable = true, Description = "Powerful pickup truck for heavy-duty tasks. Features a 3.5L EcoBoost engine, towing capacity of 13,000 lbs, and a rugged design.", ImageUrl = "/images/vehicles/ford-f150.jpg" },
                    new Vehicle { Brand = "BMW", Model = "5 Series", Type = VehicleType.Luxury, PricePerDay = 25000.00m, Year = 2024, LicensePlate = "JKL-3456", IsAvailable = false, Description = "Premium luxury sedan with advanced features. Includes leather interior, heads-up display, and a powerful inline-6 engine.", ImageUrl = "/images/vehicles/bmw-5series.jpg" },
                    new Vehicle { Brand = "Volkswagen", Model = "Golf", Type = VehicleType.Hatchback, PricePerDay = 10000.00m, Year = 2023, LicensePlate = "MNO-7890", IsAvailable = true, Description = "Compact and efficient hatchback for city driving. Known for its refined handling, turbocharged engine, and sleek design.", ImageUrl = "/images/vehicles/vw-golf.jpg" },
                    new Vehicle { Brand = "Mercedes", Model = "Sprinter", Type = VehicleType.Van, PricePerDay = 22000.00m, Year = 2022, LicensePlate = "PQR-1234", IsAvailable = true, Description = "Large cargo van ideal for moving and deliveries. Offers a high roof, up to 488 cu ft of cargo space, and a diesel engine for efficiency.", ImageUrl = "/images/vehicles/mercedes-sprinter.jpg" },
                    new Vehicle { Brand = "Hyundai", Model = "Tucson", Type = VehicleType.SUV, PricePerDay = 15000.00m, Year = 2024, LicensePlate = "STU-5678", IsAvailable = true, Description = "Modern SUV with great mileage and comfort. Features a bold parametric design, Hyundai SmartSense, and a hybrid option.", ImageUrl = "/images/vehicles/hyundai-tucson.jpg" },
                    new Vehicle { Brand = "Audi", Model = "A4", Type = VehicleType.Luxury, PricePerDay = 24000.00m, Year = 2024, LicensePlate = "VWX-9012", IsAvailable = true, Description = "Stylish luxury sedan with cutting-edge technology. Includes Audi virtual cockpit, quattro all-wheel drive, and sport suspension.", ImageUrl = "/images/vehicles/audi-a4.jpg" }
                );
                await context.SaveChangesAsync();
            }
